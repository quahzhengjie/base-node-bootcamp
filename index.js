// Writing new JSON file. - similar to what we did previously
// import { write } from './filestore.js';

// // Get some data from our app
// // Could be an input so that myData is responsive/interactive in nature.
// const myData = { name: 'Quah Zheng Jie', Hobbies: 'Sleep' };
// // Save that data to our JSON DB
// write('data.json', myData);

// READING (file read module.)
// import { read } from './fileread.js'
// read('data.json');
